...
${OBJECTDIR}/AllDisClass.o: AllDisClass.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/AllDisClass.o AllDisClass.cpp
...
${OBJECTDIR}/nouns.o: nouns.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/nouns.o nouns.cpp

${OBJECTDIR}/verbs.o: verbs.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/verbs.o verbs.cpp

${OBJECTDIR}/GameClock.o: GameClock.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/GameClock.o GameClock.cpp
...
${OBJECTDIR}/cmdtree.o: cmdtree.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/cmdtree.o cmdtree.cpp
